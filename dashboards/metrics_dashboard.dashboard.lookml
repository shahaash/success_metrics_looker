- dashboard: metrics_dashboard
  ...
  description: ''
  preferred_slug: 2P2bW5UOBOirMhpHpFDefx
  elements:
  - name: ''
    type: text
    title_text: ''
  ...
  - title: Open vs Resolved Policy Issues
    ...
    y_axes: [{label: Policy Issues, orientation: left, series: [{axisId: resolved
              - count, id: resolved - count, name: Resolved}, {axisId: open - count,
            id: open - count, name: Open}], showLabels: true, showValues: true, unpinAxis: true,
  ...
  - title: Policy Issues Resolved Over Time
    ...
    type: looker_column
    fields: [policy_violation_metric.risk_level_order, policy_violation_metric.count,
      policy_violation_metric.policy_period_date]
    ...
    y_axis_zoom: true
    series_colors:
      Critical - 0 - policy_violation_metric.count: "#A50000"
      High - 1 - policy_violation_metric.count: "#F04438"
      Medium - 2 - policy_violation_metric.count: "#F79009"
      Low - 3 - policy_violation_metric.count: "#FEC84B"
      Informational - 4 - policy_violation_metric.count: "#84CAFF"
      Unknown - 5 - policy_violation_metric.count: "#D2D6DB"
  ...
  - title: Policy Issues Mean Time to Resolution
    ...
    explore: policy_violation_metric
    type: looker_line
    fields: [policy_violation_metric.policy_period_date, policy_violation_metric.policy_mttr]
  ...
  - title: Open vs Resolved AppOmni Insights
    ...
    show_silhouette: false
    totals_color: "#808080"
    y_axes: [{label: AppOmni Insights, orientation: left, series: [{axisId: count,
            id: count, name: Count}], showLabels: true, showValues: true, unpinAxis: false,
        tickDensity: default, tickDensityCustom: 5, type: linear}]
    x_axis_zoom: true
    y_axis_zoom: true
    series_colors:
      open - insight_occurrence_metric.count: "#F04438"
      resolved - insight_occurrence_metric.count: "#32D583"
      open - count: "#F04438"
      resolved - count: "#32D583"
    series_labels:
      open - insight_occurrence_metric.count: Open
      resolved - insight_occurrence_metric.count: Resolved
      open - count: Open
      resolved - count: Resolved
    hidden_pivots: {}
    defaults_version: 1
  ...
  - title: AppOmni Insights Resolved Over Time
    ...
    y_axis_zoom: true
    series_colors:
      Critical - 0 - insight_occurrence_metric.count: "#A50000"
      High - 1 - insight_occurrence_metric.count: "#F04438"
      Medium - 2 - insight_occurrence_metric.count: "#F79009"
      Low - 3 - insight_occurrence_metric.count: "#FEC84B"
      Informational - 4 - insight_occurrence_metric.count: "#84CAFF"
      Unknown - 5 - insight_occurrence_metric.count: "#D2D6DB"
    column_group_spacing_ratio: 0.4
    hidden_pivots: {}
    show_null_points: true
    interpolation: linear
  ...
  - title: AppOmni Insights Mean Time to Resolution
    ...
    explore: insight_occurrence_metric
    type: looker_line
    fields: [insight_occurrence_metric.insight_period_date, insight_occurrence_metric.insight_mttr]
